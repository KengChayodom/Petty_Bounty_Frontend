...
class _$MissingPetModelImpl implements _MissingPetModel {
  ...
  @override
  String toString() {
    return 'MissingPetModel(id: $id, ownerId: $ownerId, petName: $petName, species: $species, characteristics: $characteristics, bountyAmount: $bountyAmount, lastSeenLocation: $lastSeenLocation, lastSeenTime: $lastSeenTime, imageUrl: $imageUrl, featureVector: $featureVector, status: $status, createdAt: $createdAt, distanceMeters: $distanceMeters, similarity: $similarity, primaryColorHex: $primaryColorHex, patternId: $patternId)';
  }
